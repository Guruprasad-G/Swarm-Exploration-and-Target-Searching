...
camera = robot.getDevice("camera_on_turret")
camera.enable(timeStep)
camera.recognitionEnable(timeStep)
print("camera instance has recognition ability or not (True/False)?\nAns :",Camera.hasRecognition(camera))
#Objects = Camera.getRecognitionObjects(camera)
#id = firstObject.get_id()
#position = firstObject.get_position()
#print("Objects =",Objects)#,"Position =",position)
